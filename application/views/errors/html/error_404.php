...
<!-- Mirrored from demo.interface.club/limitless/layout_1/LTR/material/error_404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Apr 2018 09:39:03 GMT -->
			...
			<div class="content-wrapper">
				...
				<div class="content">
						...
						<div class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3">
							<form action="#" class="main-search panel panel-body">
								...
								<div class="text-center">
									<a href="<?php echo base_url(); ?>" class="btn bg-pink-400"><i class="icon-circle-left2 position-left"></i> Back to dashboard</a>
								</div>
							</form>
						</div>
					</div>
					...
					<div class="footer text-muted text-center">
						&copy; 2015. <a href="#">Proyecto Base Material</a> by <a href="#">HITCEL</a>
					</div>
					<!-- /footer -->
