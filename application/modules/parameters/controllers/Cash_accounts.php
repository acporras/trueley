...
class Cash_accounts extends MX_Controller {
	...
	public function __construct(){
		...
		$this->load->model('mcash_accounts');
		//Idioma
		$this->lang->load('cash_accounts', $this->_session->data->idioma);
	}
