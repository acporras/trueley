...
class Judicial_offices extends MX_Controller {
	...
	public function __construct(){
		...
		$this->load->model('mjudicial_offices');
		//Idioma
		$this->lang->load('judicial_offices', $this->_session->data->idioma);
	}
	...
	public function index()
	{
		$data = [
			...
			"clase"       => "judicial_offices",
			"conf"        => $this->_conf,
			"novedades"  => $this->mjudicial_offices->_getNovedades(),
		];

		$this->load->view('layouts/admin/Header',$data);
		$this->load->view('layouts/admin/Navbar',$data);
		$this->load->view('layouts/admin/Sidebar',$data);
		$this->load->view('Vjudicial_offices',$data);
