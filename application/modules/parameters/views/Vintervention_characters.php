        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Lista de Caracteres de Intervención</h3>
                    <div class="heading-elements">
                        <a href="#" onClick="" class="uk-icon-button uk-margin-small-right newInterventionCharacter" uk-icon="plus" uk-tooltip="title: Nuevo Caracer de Intervencion" ></a>
                    </div>
                </div>
                                        ...
                                        <td>
                                            ...
                                            <div uk-dropdown="mode: click; pos:top-left">
                                                <ul class="uk-nav uk-dropdown-nav">
                                                    <li class="uk-active">
                                                        <a href="#" data-id="<?php echo $item->idCaracterIntervencion ?>" onclick="editInterventionCharacter(<?php echo $item->idCaracterIntervencion ?>);">
                                                            <i class="icon-database-edit2 text-primary"></i>
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li class="uk-active">
                                                        <a href="#" data-id="<?php echo $item->idCaracterIntervencion ?>" onclick="delInterventionCharacter(<?php echo $item->idCaracterIntervencion ?>);">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Nuevo Caracter de Intervención</h4>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="<?php echo $url ?>parameters/intervention_characters/newinterventioncharacter" id="formnew">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="modal fade" id="modal-edit">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title">Editar Caracter de Intervención</h4>
                    </div>
                    <div class="modal-body">
                        <form method="post" action="<?php echo $url ?>parameters/intervention_characters/updateinterventioncharacter" id="formedit">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                            ...
                            <input type="hidden" name="id" id="txtIdInterventionCharacter"/>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">
...
<script type="text/javascript">
    ...
    function editInterventionCharacter(dataid){
        var id = dataid;

        $.post('<?php echo $url ?>parameters/intervention_characters/getfulldata',{
            id:id
        })
        .done(function(resp){
            if(resp !="201"){
                ...
                $("#txtIdInterventionCharacter").val(d.idCaracterIntervencion);
    ...
    function delInterventionCharacter(dataid){
        var id = dataid;
        UIkit.modal.confirm('¿Esta seguro de eliminar el Caracter de Intervención?').then(function () {
            UIkit.modal.prompt('Ingrese su clave de acceso para confirmar la eliminación', '').then(function (clave) {
                ...
                $.post('<?php echo $url ?>parameters/intervention_characters/delInterventionCharacter',{
                    id:id,
                    clave:clave
                })
                .done(function(resp){
                    ...
                    $("body").unblock();
                    if($.trim(resp)=="200"){
                        UIkit.modal.alert('Se ha eliminado el Caracter de Intervención correctamente, se procederá a refrescar las listas').then(function () {
                            window.location.href="<?php echo $url ?>parameters/intervention_characters";
                        });
    ...
    $(function(){
        switch (msg) {
            ...
            case 'SuccessInsert':
                var msga = $("#modal-alert2").iziModal({
                    title: "Exito!",
                    subtitle: 'Se ha registrado el Caracter de Intervención',
                    headerColor: '#4f7c34',
                    width: 600,
                    timeout: 7000,
                    setZindex:2000000,
            ...
            case 'FailedInsert':
                var msga = $("#modal-alert2").iziModal({
                    title: "Error!",
                    subtitle: 'No se pudo insertar el Caracter de Intervención',
                    headerColor: '#BD5B5B',
                    width: 600,
                    timeout: 7000,
                    setZindex:2000000,
            ...
            case 'SuccessUpdate':
                var msga = $("#modal-alert2").iziModal({
                    title: "Exito!",
                    subtitle: 'Se ha actualizado correctamente el Caracter de Intervencion',
                    headerColor: '#4f7c34',
                    width: 600,
                    timeout: 7000,
                    setZindex:2000000,
            ...
            case 'FailedUpdate':
                var msga = $("#modal-alert2").iziModal({
                    title: "Error!",
                    subtitle: 'No se pudo actualizar el Caracter de Intervención',
                    headerColor: '#BD5B5B',
                    width: 600,
                    timeout: 7000,
                    setZindex:2000000,
        ...
        $(".newInterventionCharacter").click(function(e){
            e.preventDefault();
